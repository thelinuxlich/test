...
const updateLeavePolicyById = async (name: string, id: number): Promise<number> => {
...
const getUsersByPolicyId = async (policyId: number): Promise<any[]> => {
  const query = `
    SELECT
      t2.id,
      t2.name,
...
const updatePolicyUsersById = async (policyId: number, userIds: string): Promise<number> => {
...
const enableDisableLeavePolicy = async (status: boolean, policyId: number): Promise<number> => {
...
const deleteUserFromPolicyById = async (userId: number, policyId: number): Promise<number> => {
...
const createNewLeaveRequest = async (payload: LeaveRequestPayload): Promise<number> => {
  const now = new Date();
...
const updateLeaveRequestById = async (payload: LeaveRequestPayload): Promise<number> => {
...
const deleteLeaveRequestByRequestId = async (requestId: number): Promise<number> => {
...
const findReviewerIdByRequestId = async (requestId: number): Promise<any> => {
  const query = `
...
const findPolicyStatusById = async (id: number): Promise<any> => {
